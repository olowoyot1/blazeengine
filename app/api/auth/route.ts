...
export async function POST(req: Request) {
  ...
  return NextResponse.json({ ok: true, mustChangePassword: !!u.must_change_password, needsPinSetup: !u.username || !u.pin_hash, loginMode: u.username && u.pin_hash ? 'pin' : 'password' });
}
